...
# load fitted models
mod <- readRDS("outputs/fitted/full-model-test-with-5yo.rds")
...
# var_names <- c("rrang_spwn_mld" = "Proportional variability in spawning flows",
#                "prop_spr_lt" = "Spring flow as a proportion of long-term median flow",
#                "prop_sum_lt" = "Summer flow as a proportion of long-term median flow",
#                "prop_win_lt" = "Winter flow as a proportion of long-term median flow",
#                "prop_maxan_lt_ym1" = "Previous year's maximum daily flow as a proportion of long-term median flow",
